        ...
        <div className="w3-row-padding w3-padding-64 w3-container">
          <div className="w3-content">
            ...
            <Card
              ...
              className="mb-2"
            ><center>
              <Card.Header><p style={{fontSize:30}}>Funding Pool</p></Card.Header>
              <Card.Body>
                <Card.Title><p style={{fontSize:30}}>{parseFloat(fundingPool).toFixed(2)} CELO</p></Card.Title>
                <Card.Text>
              ...
              To add a project, the user must upload a pitch and stake a small amount (currently 2 CELO). This is to avoid spam projects. 
              The community can then vote for projects, where a single vote costs a minimum amount of 2 CELO. Voters are also eligible to 
            ...
            <Card
              ...
              className="mb-2"
            >
              <Card.Header><p style={{fontSize:30}}>Matching Pool</p></Card.Header>
              <Card.Body>
                <Card.Title><p style={{fontSize:30}}>{parseFloat(matchingPool).toFixed(2)} CELO</p></Card.Title>
                <Card.Text>
        ...
        <div className="w3-row-padding w3-light-grey w3-padding-64">
          <div className="w3-content">
            ...
            <div className="w3-twothird">
              ...
              <br/><br/>
              <h5 className="w3-padding-32">Community Voters/Investors can access pitch content of the projects. They can 
